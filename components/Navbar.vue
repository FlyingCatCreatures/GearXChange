...
// Double negation converts to a boolean
...
<template>
  <div>
    <!-- Toast div for login/logout notification -->
    ...
    <div class="navbar bg-base-100 shadow-sm fixed top-0 left-0 w-full z-50">
      ...
      <div class="flex gap-2">
        ...
        <!-- Dropdown menu containing profile & logout-->
        <!-- Completely hidden if not logged in, in that case clicking the profile icon just takes you to the login page -->
